          ...
          <div className="block sm:flex text-white">
            <div className="block sm:flex-1">
              ...
              <img
                src="./gif/coding.gif"
                alt=""
                className="sm:size-full w-[100px] h-[100px] flex justify-center mx-auto"
              />
            </div>
            <div className="flex-1">
              ...
              <div className="mb-10 text-[14px] sm:text-[18px] indent-8 pl-5">
                <p>
                  ...
                  Facilis vero placeat sit eos quam accusamus exercitationem
                  natus pariatur, mollitia qui similique, modi voluptatum nulla
                  corrupti adipisci esse repudiandae. Facilis magnam delectus
                  suscipit dolorem exercitationem unde quibusdam commodi,
                  veritatis, voluptates dignissimos eligendi? Aut quidem placeat
                  molestias id exercitationem asperiores corporis cumque.
                </p>
              </div>
